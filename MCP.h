...
void MCPsetup()
{
  ...
  //Wire.beginTransmission(MCP_ADDR); //begin transmission to MCP_ADDR
  //Wire.write(IODIRA);               //Set register to write to - IO Direction Input/Output setting
  //Wire.write(0xFC);                 //Write 1111 1100 to the port A to turn pins 0-1 as outputs and leave 2-7 as inputs 
  //Wire.endTransmission();           //Complete transmission

  //Wire.beginTransmission(MCP_ADDR); 
  //Wire.write(IODIRB);               //Set register to write to - IO Direction Input/Output setting
  //Wire.write(0b00111111);           //Write 0011 1111 to the port to turn pins 0-1 as outputs and leave 2-7 as inputs 
  //Wire.endTransmission();           
//
//  Wire.beginTransmission(MCP_ADDR); //begin transmission to MCP_ADDR
//  Wire.write(IPOLA);               //Set register to write to - IO Direction Input/Output setting
//  Wire.write(0xFC);                 //Write 1111 1100 to the port A to turn pins 0-1 as outputs and leave 2-7 as inputs 
//  Wire.endTransmission();           //Complete transmission
//
//  Wire.beginTransmission(MCP_ADDR); 
//  Wire.write(IPOLB);               //Set register to write to - IO Direction Input/Output setting
//  Wire.write(0b00111111);           //Write 0011 1111 to the port to turn pins 0-1 as outputs and leave 2-7 as inputs 
//  Wire.endTransmission();           
